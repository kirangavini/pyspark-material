...
ccRaw = SpContext.textFile("C:\\Users\\kiran\\Desktop\\SparkPythonDoBigDataAnalytics-Resources\\SparkPythonDoBigDataAnalytics-Resources\\credit-card-default-1000.csv")
ccRaw.take(5)
...
#Perfo rm first round Correlation analysis
